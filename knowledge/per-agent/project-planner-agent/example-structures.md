...
- [ ] Draft commit URL/SHA recorded
- [ ] Adversarial Agent approval or Orchestrator accept-risk posted
- [ ] No unresolved critical findings
- [ ] Final section persisted at paladin-mantle-integration/research-sections/paladin-architecture/final.md
- [ ] Final Promotion Ready posted with Index Entry Proposal
- [ ] Research Complete posted on TW issue after _index.md commit
...
**Sections index commit/URL**: def5678
...
- **Project slug**: paladin-mantle-integration
- **Sections index**: paladin-mantle-integration/research-sections/_index.md (Orchestrator-serialized)
...
(see Research Complete template in system prompt)
