...
description: "Use when coordinating a Multica research squad project, dispatching research/review/TW agents, resuming orchestration, managing a run ledger, serializing _index.md writes, or deciding approve/revise/accept-risk/block transitions."
---
...
- `references/research-outline-schema.md` — outline schema when validating pre-planned and Research artifacts.
...
3. Load and validate pre-planned research issues, slugs, ordering, dependencies, and TW reserved issue metadata.
...
Project mode prerequisite: the research issue set and TW reserved issue must already exist from Project Planner or an equivalent pre-planning process. If they are absent or incomplete, post `BLOCKED` with the missing prerequisites instead of dispatching Planner or guessing the project structure.
