...
- workflow details -> `agents/{agent-name}/skills/{skill}/SKILL.md` plus `references/workflow.md`;
...
- `agents/{agent-name}/{agent-name}.yaml`;
...
Run `systems/validate/validate` after creating or updating agent configs.
